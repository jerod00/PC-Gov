...
ALREADY_KNOWN = [
    ...
    "Harris County, TX Bonfire portal (public Opportunity RSS feed, source built)",
    "San Angelo, TX Bonfire portal (public Opportunity RSS feed, source built)",
    "Waco, TX Bonfire portal (public Opportunity RSS feed, source built)",
